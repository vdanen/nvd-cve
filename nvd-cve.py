...
#    print(years)
    ...
    for gzfile in years:
        if os.path.isfile(gzfile):
            ...
            dt_mod = datetime.datetime.fromtimestamp(os.path.getmtime(gzfile))
...
def main():
    ...
    parser.add_argument('--year-stats', dest='year_stats', action='store_true', default=False, help='Display CVE count by year')
